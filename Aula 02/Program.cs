    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
			...
			//media >= 7  aluno é aprovado, media menos que 4 retido, entre 4 e 7 está de exame
            ...
            {
                Console.WriteLine("Deverá realizar exame, média " + media + 
                    "\nInforme a nota do exame: ");

                double notaExame =Convert.ToDouble(Console.ReadLine());
                double mediaExame = (media + notaExame) / 2;
                if(mediaExame >= 6 )
					Console.WriteLine("Aprovado em exame com média " + mediaExame);
                else
					Console.WriteLine("Reprovado após exame com média " + mediaExame);
			}
            */

			//Usuario deverá digitar o usuário e a senha se estiver correto enviar msg de boas vindas
			//caso contrário, enviar msg usuário/senha inválidos
            ...
            {
                Console.WriteLine("Usuario/senha inválido");
            }
            */
